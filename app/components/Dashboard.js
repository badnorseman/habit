...
export default class Dashboard extends Component {
  ...
  render() {
    ...
    const header = Object.keys(this.props.data).length === 0 ? 'Hey, I see nothing here. Let\'s select one of the habits and get started.' : 'What habit are we checking off?'
    return (
